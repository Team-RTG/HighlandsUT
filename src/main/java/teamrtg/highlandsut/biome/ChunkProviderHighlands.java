...
public class ChunkProviderHighlands implements IChunkProvider{
            ...
            for (int k1 = 0; k1 < 5; ++k1)
            {
                ...
                for (int l1 = -b0; l1 <= b0; ++l1)
                {
                    for (int i2 = -b0; i2 <= b0; ++i2)
                    {
                        ...
                        if(biomegenbase1.equals(Biome.ocean)){
                        	//f5 = -1;
    ...
    public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
    {
        ...
        if (biomegenbase != Biome.desert && biomegenbase != Biome.desertHills && this.settings.useWaterLakes && !flag && this.rand.nextInt(this.settings.waterLakeChance) == 0
    ...
    {
        Biome biomegenbase = this.worldObj.getBiomeGenForCoords(p_177458_2_);
